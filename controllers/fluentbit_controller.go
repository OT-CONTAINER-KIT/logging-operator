...
//+kubebuilder:rbac:groups=logging.opstreelabs.in,resources=fluentbits,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=logging.opstreelabs.in,resources=fluentbits/status,verbs=get;update;patch
...
func (r *FluentBitReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("fluentbit", req.NamespacedName)
